...
int main() {
    ...
    myDeque.push_front(0); // Add 0 to the front
    myDeque.push_back(6);  // Add 6 to the back
    ...
    myDeque.pop_front(); // Remove element from the front
    myDeque.pop_back();  // Remove element from the back
    ...
    myDeque.insert(it, 10); // Insert 10 at the third position
    ...
    myDeque.erase(it); // Remove the element at the current iterator position
